...
<i class="fa-solid fa-envelope"></i> <a href="mailto:lk@ps.au.dk">lk\@ps.au.dk</a><br> <i class="fa-brands fa-bluesky"></i> `<a href="https://bsky.app/profile/laurakettel.bsky.social"`{=html}@laurakettel.bsky.social</a><br> <i class="fa-solid fa-graduation-cap"></i> `<a href="https://scholar.google.com/citations?user=VXHHAT4AAAAJ&hl=en"`{=html}Google Scholar</a><br> <i class="fa-brands fa-github"></i> `<a href="https://github.com/laurakettel"`{=html}GitHub</a>
